<template>
  ...
  >
    <div v-if="userReceivingGems">
      ...
      >
        <h3 class="panel-heading d-block text-center">
          Send Gift to:
        </h3>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-12 text-center">
              <img class="img-responsive" src="https://i.pinimg.com/736x/e9/37/83/e9378343735ccb235d94d43de076e47e.jpg" style="max-height:147px;">
            </div>
            <div class="col-md-12 text-center">
              <strong><p
                class="medium" style="margin-bottom:1px"
              >{{ receiverName }}</p></strong>
              <p
                class="small"
              >@{{ this.userReceivingGems.auth.local.username }}</p>
            </div>
          </div>
        </div>
      </div>
